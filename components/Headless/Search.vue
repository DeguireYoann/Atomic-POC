...
const search = () => {
  props.hydratedController.submit();
  emit('search');
}

const updateSearchText = (event) => {
  props.hydratedController.updateText(event.target.value);
};
...
.search-button {
  @apply p-2.5 ms-2 text-sm font-medium text-white bg-blue-700 rounded-lg border border-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800;
}
